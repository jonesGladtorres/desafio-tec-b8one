  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f6f8f5] px-6 py-10">
      <section className="w-full max-w-xl rounded-[32px] border border-[#dfe8e2] bg-white p-8 text-center shadow-[0_24px_70px_rgba(44,75,66,0.10)]">
        <span className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-[#eef6f2] text-[#2f7d67]">
          <Compass size={26} />
        </span>
        ...
        <p className="mt-3 text-base leading-7 text-[#66756f]">
          O caminho que você tentou acessar não existe mais ou foi movido. Volte ao
          catálogo de exames para continuar.
        </p>
        <div className="mt-7 flex flex-wrap justify-center gap-3">
          <Link
            href="/exams"
            className="inline-flex h-12 items-center justify-center rounded-2xl bg-[#2f7d67] px-5 text-sm font-bold text-white shadow-[0_14px_30px_rgba(47,125,103,0.22)] transition hover:bg-[#276b58]"
          >
            Ir ao catálogo
          </Link>
          <Link
