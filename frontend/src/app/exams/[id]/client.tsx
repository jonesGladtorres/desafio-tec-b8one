      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_420px]">
            ...
            <>
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-2">
                <article className="rounded-[28px] bg-[#f7faf8] p-6">
                  ...
                  <h2 className="mt-4 text-lg font-black text-[#18352d]">Sobre o exame</h2>
                  <p className="mt-3 text-sm leading-7 text-[#63736d]">{exam.description}</p>
                </article>
                <article className="rounded-[28px] bg-[#fff8eb] p-6">
                  <CheckCircle2 className="text-[#9a7332]" size={24} />
                  <h2 className="mt-4 text-lg font-black text-[#4d3a1c]">Preparo</h2>
        ...
        <aside className="rounded-[32px] border border-[#dfe8e2] bg-white p-6 shadow-[0_18px_60px_rgba(44,75,66,0.08)]">
          ...
          <label className="mt-6 block">
            <span className="mb-2 block text-sm font-bold text-[#315348]">Data</span>
            <input
              value={date}
              onChange={(event) => {
